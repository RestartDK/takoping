...
import { createDiagramTool, updateDiagramTool } from "../ai/tools";
...
export const chatRoute = async (req: Request) => {
	...
	try {
		// Initialize model (same logic as agent.ts)
		let model;
		...
		// Create searchKnowledge tool inline with owner/repo context
